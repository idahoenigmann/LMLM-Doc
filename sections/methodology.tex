...
In Neural Networks the initial weights of all layers has to be set before training can begin. These weights can either be set to some constant value or initialized by random values from some distribution. Some basic initializer distributions are plotted in Fig~\ref{pic:methodology_neuralNetwork_initializerFunctions1} and Fig~\ref{pic:methodology_neuralNetwork_initializerFunctions2}.
