...
\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_neuralNetwork_activationFunction_elu.png}
	\caption{...}
	\label{pic:methodology_neuralNetwork_activationFunction_elu}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_neuralNetwork_activationFunction_selu.png}
	\caption{...}
	\label{pic:methodology_neuralNetwork_activationFunction_selu}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_neuralNetwork_activationFunction_softplus.png}
	\caption{...}
	\label{pic:methodology_neuralNetwork_activationFunction_softplus}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_neuralNetwork_activationFunction_softsign.png}
	\caption{...}
	\label{pic:methodology_neuralNetwork_activationFunction_softsign}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_neuralNetwork_activationFunction_relu.png}
	\caption{...}
	\label{pic:methodology_neuralNetwork_activationFunction_relu}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_neuralNetwork_activationFunction_tanh.png}
	\caption{...}
	\label{pic:methodology_neuralNetwork_activationFunction_tanh}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_neuralNetwork_activationFunction_sigmoid.png}
	\caption{...}
	\label{pic:methodology_neuralNetwork_activationFunction_sigmoid}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_neuralNetwork_activationFunction_exponential.png}
	\caption{...}
	\label{pic:methodology_neuralNetwork_activationFunction_exponential}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_neuralNetwork_activationFunction_linear.png}
	\caption{...}
	\label{pic:methodology_neuralNetwork_activationFunction_linear}
\end{figure}
