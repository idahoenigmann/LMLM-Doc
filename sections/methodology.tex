...
%		\includegraphics[width=\linewidth]{img/methodology_neuralNetwork_activationFunction_softsign.png}
%		\caption{...}
%		\label{pic:methodology_neuralNetwork_activationFunction_softsign}
%	\end{subfigure}
%	
%	\begin{subfigure}[b]{.45\linewidth}
%		\includegraphics[width=\linewidth]{img/methodology_neuralNetwork_activationFunction_relu.png}
%		\caption{...}
%		\label{pic:methodology_neuralNetwork_activationFunction_relu}
%	\end{subfigure}
%	
%	\begin{subfigure}[b]{.45\linewidth}
%		\includegraphics[width=\linewidth]{img/methodology_neuralNetwork_activationFunction_tanh.png}
%		\caption{...}
%		\label{pic:methodology_neuralNetwork_activationFunction_tanh}
%	\end{subfigure}
%	
%	\begin{subfigure}[b]{.45\linewidth}
%		\includegraphics[width=\linewidth]{img/methodology_neuralNetwork_activationFunction_sigmoid.png}
%		\caption{...}
%		\label{pic:methodology_neuralNetwork_activationFunction_sigmoid}
%	\end{subfigure}
%	
%	\begin{subfigure}[b]{.45\linewidth}
%		\includegraphics[width=\linewidth]{img/methodology_neuralNetwork_activationFunction_exponential.png}
%		\caption{...}
%		\label{pic:methodology_neuralNetwork_activationFunction_exponential}
%	\end{subfigure}
%	
%	\begin{subfigure}[b]{.45\linewidth}
%		\includegraphics[width=\linewidth]{img/methodology_neuralNetwork_activationFunction_linear.png}
%		\caption{...}
