...
Barrel distortion occurs when the lens used by the camera has a higher magnification at the centre of the image then at the sides. ...

\begin{figure}[h!]
	\centering
	\includegraphics[width=4.5in]{img/methodology_stereoCamera_distortion_barrelDistortion.png}
	\caption{Left image shows the original image composed of straight horizontal and vertical lines. The right image is distorted using the barrel distortion which causes the lines to curve toward the outside of the image, causing the lines to appear in a barrel like shape.[TODO: change image to own] }
